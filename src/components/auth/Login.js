...
const Login = props => {
  const [credentials, setCredentials] = useState({userId: "", email: "", password: "" }); //initial state equal to an object with keys email and password that have empty string value
